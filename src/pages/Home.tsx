  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="mt-[18vh] text-center sm:mt-[38vh]">
        <h1 className="montserrat mt-25 mb-10 px-5 text-5xl font-bold text-black text-shadow-lg sm:mt-0 dark:text-white dark:text-shadow-[8px_8px_16px_rgba(0_0_0_/_1.0)]">
          Welcome to the Simple Planning Poker
        </h1>
        <p className="montserrat mb-10 px-5 text-lg font-bold text-zinc-700 text-shadow-lg dark:text-zinc-300 dark:text-shadow-[4px_4px_8px_rgba(0_0_0_/_0.8)]">
